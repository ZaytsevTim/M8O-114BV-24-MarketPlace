...
products = [
    ...
    {'id': 9, 'name': 'Корм для собак BAXAREV', 'price': 999, 'disc': "Легендарный корм с легендарной историей."},
    {'id': 10, 'name': 'Миска для корма', 'price': 400, 'disc': "Качественная посуда из нержавеющей стали."},
    {'id': 11, 'name': 'Корм для кошек Lower', 'price': 200, 'disc': "Лакомства для питомцев со средним бюджетом."},
    {'id': 12, 'name': 'Аквариум шарообразный', 'price': 1600, 'disc': "Уютное жилище из качественного стекла."}
